...
# ML Feature Engineering + Flink-Style Stream Processing
#
# Usage:
...
OUTPUT_DIR="/tmp/arkprobe_appworkload_$$"
...
echo "=========================================================="
echo " ArkProbe Application Workload Benchmark (Java vs C++)"
echo "=========================================================="
...
echo "[Phase 1] Compiling AppWorkloadBench.java..."
cd "${JAVA_DIR}"
export JAVA_HOME
javac AppWorkloadBench.java
echo "  Done."

# ---- Phase 2: Run pure Java baseline ----
echo "[Phase 2] Running pure Java baseline..."
java -Xmx4g AppWorkloadBench > "${OUTPUT_DIR}/baseline.json" 2>"${OUTPUT_DIR}/baseline_stderr.txt"
...
g++ -shared -fPIC -O3 -march=native \
    -o "${OUTPUT_DIR}/libarkprobe_appworkload.so" \
    "${JAVA_DIR}/arkprobe_appworkload.cpp" \
    -I"${JAVA_HOME}/include" -I"${JAVA_HOME}/include/linux"

echo "  Built: ${OUTPUT_DIR}/libarkprobe_appworkload.so"

# ---- Phase 4: Run accelerated benchmark ----
echo "[Phase 4] Running C++ accelerated benchmark..."
java -Xmx4g -Djava.library.path="${OUTPUT_DIR}" AppWorkloadBench > "${OUTPUT_DIR}/accelerated.json" 2>"${OUTPUT_DIR}/accelerated_stderr.txt"
